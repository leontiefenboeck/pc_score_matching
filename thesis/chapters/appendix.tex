...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\hspace*{-1cm} \includegraphics[width=0.7\textwidth]{figures/halfmoons/10_random1.png}}
    \vskip 5pt
    \makebox[\textwidth][c]{\hspace*{-1cm} \includegraphics[width=0.7\textwidth]{figures/halfmoons/10_random2.png}}
    \vskip 5pt
    \makebox[\textwidth][c]{\hspace*{-1cm} \includegraphics[width=0.7\textwidth]{figures/halfmoons/10_random3.png}}
