...
%% general metadata:
\newcommand{\myauthor}{Leon Tiefenböck}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}}  %% including
\newcommand{\mytitle}{Training Tractable Probabilistic Models via Score Matching Objectives}  %% also used for PDF metadata (hyperref)
...
\newcommand{\mysupervisor}{Dipl.-Ing. Thomas Wedenig} %% your supervisor
\newcommand{\mycosupervisor}{\ }  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\myevaluator}{Dipl.-Ing. Thomas Wedenig} %% your supervisor
\newcommand{\myhomestreet}{Münzgrabenstraße 321c} %% your home street (with house number)
...
\newcommand{\mysubmissionyear}{2025} %% year you are handing in
\newcommand{\mysubmissiontown}{\myhometown} %% town of handing in (or \myhometown)


%% additional information for generic_documentation title page
\newcommand{\myid}{11919874} %% Matrikelnummer
