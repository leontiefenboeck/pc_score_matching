...
\newcommand{\mybiblatexcitestyle}{numeric} % citestyle of biblatex
...
%% general metadata:
\newcommand{\myauthor}{Thomas Wedenig}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, BSc}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Exact Inference in Side-Channel Attacks \\ using Tractable Probabilistic Models}  %% also used for PDF metadata (hyperref)
...
\newcommand{\mysupervisor}{Ass.-Prof. Dipl.-Ing. Dr. techn. Robert Peharz} %% your supervisor
\newcommand{\mycosupervisor}{\ }  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\myevaluator}{Ass.-Prof. Dipl.-Ing. Dr. techn. Robert Peharz} %% your supervisor
\newcommand{\myhomestreet}{Grabenstraße 56/7} %% your home street (with house number)
...
\newcommand{\myid}{11812594} %% Matrikelnummer
...
\setcounter{biburlucpenalty}{8000} % break url in references
...
\include{chapters/abstract_german}              %% Abstract
